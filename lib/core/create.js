...
const createCommands = () => {
  ...
  g.command('page <name>').description('add react page, e.g., czh g page Home [-d dest], defaults to the React framework. If another framework is needed, use [-f vue]').action(name => {
